export const STORAGE_KEYS = {
  accessToken: 'afoma.accessToken',
  user: 'afoma.user',
  lastLoginEmail: 'afoma.lastLoginEmail',
  recentSearches: 'afoma.recentSearches',
  recentlyViewed: 'afoma.recentlyViewed',
  guestCart: 'afoma.guestCart',
