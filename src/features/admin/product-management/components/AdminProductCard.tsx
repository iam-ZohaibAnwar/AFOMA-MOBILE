...
import {
  ...
  getAdminProductSubtitle,
  isAdminProductDimmed,
  resolveAdminProductAccentColor,
  resolveAdminProductListStatusChips,
...
export interface AdminProductCardProps {
  ...
  onMenuPress: (product: AdminProductListItem) => void;
  isBusy?: boolean;
}
...
export function AdminProductCard({
  ...
  const dimmed = isAdminProductDimmed(product);
  const imageUrl = getProductImageUrl(product);
  const accentColor = resolveAdminProductAccentColor(product);
  const subtitle = getAdminProductSubtitle(product);
  const statusChips = resolveAdminProductListStatusChips(product);
        ...
        <View style={styles.content}>
          ...
          <View style={styles.footerRow}>
            <AppText variant="bodyMedium" style={[styles.price, dimmed && styles.priceDimmed]}>
              {formatAdminProductListPrice(product)}
            </AppText>
