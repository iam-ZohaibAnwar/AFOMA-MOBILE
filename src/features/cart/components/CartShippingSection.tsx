...
import { formatShippingOptionSummary } from '../utils/shippingSummary';
      ...
      {!canFetchRates ? (
        ...
        <View style={styles.summaryBox}>
          ...
          {selectedOptions.map((option) => (
            ...
            <View key={`${option.sellerId}-${option.id}`} style={styles.summaryRow}>

              {hasMultipleSellers ? (

                <AppText variant="caption" color="textSecondary" style={styles.sellerLabel}>
              ...
              <AppText variant="bodyMedium" style={styles.summaryText}>
                ...
                {formatShippingOptionSummary(option)}
