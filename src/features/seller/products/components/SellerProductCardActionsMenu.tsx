...
export type SellerProductCardActionId =
  | 'edit'
  | 'submitForReview'
  | 'activate'
  | 'deactivate'
...
export interface SellerProductCardAction {
  id: SellerProductCardActionId;
  label: string;
  destructive?: boolean;
  disabled?: boolean;
}

export interface SellerProductCardActionsMenuProps {
  visible: boolean;
  productName?: string;
  actions: SellerProductCardAction[];
  onClose: () => void;
  onSelect: (actionId: SellerProductCardActionId) => void;
}

export function SellerProductCardActionsMenu({
  visible,
  productName,
  actions,
  onClose,
  onSelect,
}: SellerProductCardActionsMenuProps) {
