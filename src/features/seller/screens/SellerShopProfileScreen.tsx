...
import { SELLER_SHOP_PROFILE_SECTIONS } from '../utils/sellerProfileSections';
    ...
    >
      <AppCard variant="muted">
        ...
        <AppText variant="bodySmall" color="textSecondary" style={styles.copy}>
          Manage your storefront details, branding, and shop policies.
        </AppText>
      </AppCard>
      ...
      <AppCard variant="flat">
        {SELLER_SHOP_PROFILE_SECTIONS.map((section) => (
