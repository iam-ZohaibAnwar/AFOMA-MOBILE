...
interface CustomerOrderDetailLineRowProps {
  order: OrderDetail;
  line: CartLineItem;
}
...
export function CustomerOrderDetailLineRow({ order, line }: CustomerOrderDetailLineRowProps) {
      ...
      <View style={styles.details}>
        ...
        {isDownloadable && downloadUrl ? (
          <Pressable
            ...
            style={({ pressed }) => [
              styles.downloadLink,
              pressed && !orderCancelled && styles.downloadPressed,
            ]}
          >
            <AppText
              variant="caption"
              color={orderCancelled ? 'textMuted' : 'textLink'}
